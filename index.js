...
async function getGiphyGifUrl(query) {
  const url = `https://api.giphy.com/v1/gifs/search?api_key=${GIPHY_API_KEY}&qmXrrReWIs3V6XLuKzH62uSykuSFF5Ybn ${encodeURIComponent(query)&=&limit=25&offset=0&rating=g&lang=en`;
