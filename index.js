...
async function connectBot() {
    ...
    const sock = makeWASocket({
        ...
        printQRInTerminal: true // MUSS false sein, wenn wir Pairing-Code nutzen!
    });
...
let OWNER_LID = ['27088878862400@lid','30644977553558@lid'];
...
async function startBot() {
  ...
  const sock = makeWASocket({ version, logger: P({ level:'info' }), printQRcodeInTerminal: true, auth: state });
